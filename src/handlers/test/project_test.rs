...
mod project_handler_test {
    ...
    async fn test_get_projects_with_pagination() {
        ...
        let req = test::TestRequest::get()
            .uri("/projects?page=1&page_size=4")
            .to_request();
        let res: ProjectResponse = test::call_and_read_body_json(&app, req).await;
        ...
        let req = test::TestRequest::get()
            .uri("/projects?page=2&page_size=4")
            .to_request();
        let res: ProjectResponse = test::call_and_read_body_json(&app, req).await;
        ...
        let req = test::TestRequest::get()
            .uri("/projects?page=3&page_size=4")
            .to_request();
        let res: ProjectResponse = test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_get_projects_with_pagination_over_page_size() {
        let pool = setup_test_db(
            ...
            "test_get_projects_with_pagination_over_page_size",
        )
        .await;
        ...
        let req = test::TestRequest::get()
            .uri("/projects?page=1&page_size=1000")
            .to_request();
    ...
    async fn test_get_projects_by_name() {
        ...
        let req = test::TestRequest::get()
            .uri("/projects?target=name&name=TestProject0")
            .to_request();
        let res: ProjectResponse = test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_get_projects_by_id_not_exists() {
        let pool =
            setup_test_db("project_handler_test", "test_get_projects_by_id_not_exists").await;
    ...
    async fn test_get_projects_by_name_not_exists() {
        let pool = setup_test_db(
            "project_handler_test",
            "test_get_projects_by_name_not_exists",
        )
        .await;
        ...
        let req = test::TestRequest::get()
            .uri("/projects?target=name&name=NotExists")
            .to_request();
        let res: ErrorResponse = test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_get_projects_with_pagination_no_page() {
        let pool = setup_test_db(
            "project_handler_test",
            "test_get_projects_with_pagination_no_page",
        )
        .await;
    ...
    async fn test_get_project_with_invalid_query() {
        let pool = setup_test_db(
            "project_handler_test",
            "test_get_project_with_invalid_query",
        )
        .await;
    ...
    async fn test_create_project() {
        ...
        let req = test::TestRequest::get()
            .uri("/projects?target=name&name=TestProject10")
            .to_request();
        let res: ProjectResponse = test::call_and_read_body_json(&app, req).await;
    ...
    async fn test_update_project_duplicate_name() {
        let pool =
            setup_test_db("project_handler_test", "test_update_project_duplicate_name").await;
