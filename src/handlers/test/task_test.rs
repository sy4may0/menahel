...
mod task_handler_test {
    ...
    async fn test_get_tasks_by_id_with_user() {
        ...
        assert_eq!(res.message, "OK");
        assert_eq!(res.count, 1);
        assert_eq!(res.results[0].users.len(), 3);
        assert_eq!(res.results[0].users[0].user_id, Some(0));
        assert_eq!(res.results[0].users[1].user_id, Some(1));
        assert_eq!(res.results[0].users[2].user_id, Some(2));
    }
    ...
    async fn test_get_tasks_by_full_filter() {
        ...
        assert_eq!(res.results[0].users.len(), 2);
    }
