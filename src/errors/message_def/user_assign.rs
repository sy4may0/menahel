...
pub fn add_user_assign_error_messages(
    ...
    user_assign_same_user_assign_exists
        .insert("en", "The user is already assigned to the task");
    user_assign_same_user_assign_exists
    ...
    map.insert(ErrorKey::UserAssignGetByIdNotFound, user_assign_get_by_id_not_found);

    let mut user_assign_get_pagination_not_found = HashMap::new();
    user_assign_get_pagination_not_found.insert("en", "No user assigns found in the specified page");
    user_assign_get_pagination_not_found.insert("jp", "指定ページ内にユーザー割り当てが存在しません。");
    map.insert(ErrorKey::UserAssignGetPaginationNotFound, user_assign_get_pagination_not_found);
    ...
    user_assign_get_by_user_id_and_task_id_not_found.insert("jp", "ユーザー割り当てが見つかりません");
    map.insert(ErrorKey::UserAssignGetByUserIdAndTaskIdNotFound, user_assign_get_by_user_id_and_task_id_not_found);

    let mut user_assign_get_user_assigns_count_failed = HashMap::new();
    user_assign_get_user_assigns_count_failed.insert("en", "Failed to get user assigns count due to database operation failure");
    user_assign_get_user_assigns_count_failed.insert("jp", "DB操作処理の問題によりユーザー割り当ての数の取得に失敗しました");
    map.insert(ErrorKey::UserAssignGetUserAssignsCountFailed, user_assign_get_user_assigns_count_failed);
