...
pub fn add_project_handler_error_messages(
    ...
    map.insert(ErrorKey::ProjectHandlerGetProjectsInvalidPage, project_handler_get_projects_invalid_page);

    let mut project_handler_get_projects_invalid_target = HashMap::new();
    project_handler_get_projects_invalid_target.insert("en", "Invalid target. Target must be 'all', 'name', or 'id'");
    project_handler_get_projects_invalid_target.insert("jp", "ターゲットが無効です。ターゲットは'all'、'name'、または'id'である必要があります");
    map.insert(ErrorKey::ProjectHandlerGetProjectsInvalidTarget, project_handler_get_projects_invalid_target);
    ...
    map.insert(ErrorKey::ProjectHandlerGetProjectsNoNameSpecified, project_handler_get_projects_no_name_specified);
    ...
    map.insert(ErrorKey::ProjectHandlerGetProjectsNoIdSpecified, project_handler_get_projects_no_id_specified);
    ...
    map.insert(ErrorKey::ProjectHandlerPathAndBodyIdMismatch, project_handler_path_and_body_id_mismatch);
    ...
    map.insert(ErrorKey::ProjectHandlerInvalidJsonPost, project_handler_invalid_json_post);
    ...
    map.insert(ErrorKey::ProjectHandlerInvalidQuery, project_handler_invalid_query);
    ...
    map.insert(ErrorKey::ProjectHandlerInvalidPath, project_handler_invalid_path);
